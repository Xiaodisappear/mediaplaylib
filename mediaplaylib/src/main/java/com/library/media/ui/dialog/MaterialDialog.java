...
public class MaterialDialog extends AlertDialog {
    ...
    public interface IButtonCallback {
        ...
        //@Override
        void onNeutral(MaterialDialog dialogInterface);
    }

    public static class ButtonCallback implements IButtonCallback {
    ...
    public static class Builder {
        ...
        public Builder callback(IButtonCallback buttonCallback) {
        ...
        public MaterialDialog build(int themeId) {
            MaterialDialog dialog = new MaterialDialog(this.getContext(), themeId);
            init(dialog);
            return dialog;
        }
